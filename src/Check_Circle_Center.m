...
%     Trans_x0 = x0_temp - x_temp;       % the mapped offset translated or reference to origin (since normal vector is at origin).
%     Trans_Hx0 = Hx0_temp - Hx_temp; 
    
%     X = [Trans_x0 ; Trans_Hx0];
%     X = -[x_temp; Hx_temp];
...
%     lambda_y = (X*a)';                           % a is a 2x1 vector,
%     which is the normal vector to the tangent of the local arc
